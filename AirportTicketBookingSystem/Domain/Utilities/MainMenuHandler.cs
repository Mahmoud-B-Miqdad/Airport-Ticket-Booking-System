...
public class MainMenuHandler
{
    ...
    public MainMenuHandler(BookingHandler bookingHandler, FlightSearchHandler flightSearchHandler, AdminHandler adminHandler)
    {
        _bookingHandler = bookingHandler;
        _flightSearchHandler = flightSearchHandler;
